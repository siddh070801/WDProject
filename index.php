...
<div class="row">
<?php 
$records_query=$conn->prepare("SELECT * FROM records");
...
foreach ($rows as $row) {
    ...
    <div class="recordd-body">
        ...
        <div class="row justify-content-between px-2">
            <a href="edit_record.php?rec_id='.$row["id"].'"><button class="btn btn-warning">Edit</button></a>
            <a href="delete_record.php?rec_id='.$row["id"].'"><button class="btn btn-danger">Delete</button></a>
        </div>
    </div>
    </div>';
}
